    ...
    <div class="card">
      ...
      <div class="card__body">
        ...
        <div class="half">
          ...
          <span class="stock"><i class="fa fa-pen"></i> Order Status</span>
          <div class="reviews">
            <ul class="stars">
      ...
      <div class="card__footer">
        ...
        <div class="action">
          ...
          <a type="button" class="profile-btn" href="{{ route('adminOrder.index') }}">Go to dashboard</a>
        </div>
      </div>
    </div>
  </main>
